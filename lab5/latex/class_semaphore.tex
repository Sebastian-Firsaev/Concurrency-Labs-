...
A \doxylink{class_semaphore}{Semaphore} Implementation using C++11 features such as mutex and condition variables.  
...
\begin{DoxyCompactList}\small\item\em Waits until the semaphore\textquotesingle{}s count is greater than 0 and decrements the count. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Waits until the semaphore\textquotesingle{}s count is greater than 0 for a specified duration and decrements the count. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{class_semaphore_a86f92f738b4486439b296d8e235895f2}{Signal}} ()
\begin{DoxyCompactList}\small\item\em Increases the semaphore\textquotesingle{}s count and notifies one waiting thread. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Increases the semaphore\textquotesingle{}s count and notifies one waiting thread. 
...
Waits until the semaphore\textquotesingle{}s count is greater than 0 and decrements the count. 
...
Waits until the semaphore\textquotesingle{}s count is greater than 0 for a specified duration and decrements the count. 


\begin{DoxyParams}{Parameters}
{\em cr\+Rel\+Time} & Duration to wait for the semaphore. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
True if the semaphore is signaled within the specified duration, false otherwise. 
\end{DoxyReturn}
