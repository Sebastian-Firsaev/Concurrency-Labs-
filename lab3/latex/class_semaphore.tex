...
\begin{DoxyCompactList}\small\item\em Closes the thread until the semaphore count is greater than 0. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{class_semaphore_a86f92f738b4486439b296d8e235895f2}{Signal}} ()
\begin{DoxyCompactList}\small\item\em Allows a thread to open. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Closes the thread until the semaphore count is greater than 0. 
